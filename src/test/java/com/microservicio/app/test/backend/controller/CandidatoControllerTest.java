...
class CandidatoControllerTest {
    ...
    void setUp() {
        ...
        candidatoDto = new CandidatoDto(1l, NOMBRE_CANDIDATO, "perez",new TipoDocumento(1l,"DNI"),"12345678","calle falsa 123","linkedin.com");
        candidatoCrearDto = new CandidatoCrearDto(1l, NOMBRE_CANDIDATO, "perez",new TipoDocumento(1l,"DNI"),"12345678","calle falsa 123","linkedin.com");
